...
const char ssid_template[] = "WSPF-AP-******"; // Dynamically replaced by hardware MAC Address
const char hostname_template[] = "WSPF-******";  // Dynamically replaced by hardware MAC Address
